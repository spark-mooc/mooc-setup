 ...
 *
 */
public class NaiveSettingEval extends TestUnit {
	...
	public NaiveSettingEval(ArrayList<Resource> sources, ArrayList<Resource> targets, int k, boolean tfidf, String dataset) {
